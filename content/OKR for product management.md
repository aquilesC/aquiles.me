One of the challenges when defining [[Roadmaps for product development]] is that they are normally output-based instead of outcome-based([[literature/@cagan2018|@cagan2018]]). This means that [[product development cycle]] teams have no way of understanding how to prioritize tasks and will often do it based on internal preferences instead of aligning with the overall business. 
