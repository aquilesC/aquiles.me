Is the name of the product from [[NanoView Biosciences]] that implements the [[SP-IRIS]] method. The image below [@mizenko2021] shows an example of how the device can be used.
