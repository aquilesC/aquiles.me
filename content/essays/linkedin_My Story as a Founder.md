...
status: draft
published_on: none
epistemic: Working story for a linkedin post
---
Being a founder was definitely not in my plans when I started my PhD. During my studies I had come across only one professor who had a small side-project building tools for microscopy, but no one else. Most non-academics with whom I've been in contact were working for large, industrial, companies. 

When I joined the lab of Michel Orrit in Leiden, I very distinctively remember that in one of the first weeks he put me in contact with a former PhD in chemistry who had started his own company and was selling instruments who could be interesting for my project. 

That small action was perhaps the seed of a very lengthy and slow train of thought that lead me to where I am today. 

My path is definitely not a linear one. I didn't go from PhD, to funder, to successful businessman. 
...
Because of a mistake, a technician formatted the wrong computer in the lab and I could never get the original control software to run again. 
...
That serendipitous formatting of a computer, pushed me into explore a more complete approach to doing science. 
...
One thing lead to another, and I started organizing workshops to teach people the skills necessary to develop their own software, I started advising CEO's on how to execute their strategy, and mentored few PhD's who were struggling building a plan for their careers. 
...
With time, the path slowly became clearer, although I never had the chance to formalize it. It is hard when you don't have access to people few years ahead of you, who could tell you how the path looked for them. 

I spent countless hours reading about *the lean startup*, the *business model canvas*. Participated in workshops, discussed with lawyers, accountants, and startup coaches. 
...
In 2019, Dispertech was established, we had several shareholders, a reserve of shares for early employees, a reverse vesting strategy. The whole package: We became a real company. 
...
Coming from a well financed lab, with optical tables, tools, lasers, technicians, to having just a desk really pushes the boundaries of creativity. I bought a 3D printer to speed up my own design iterations, learned enough of CAD design to get started. 

That was the easy part, because I was on my own. I also had to find suppliers for the components we needed. 

Interacting with suppliers can be both fun and stressful. Sometimes you find very cheap alternatives but wonder how well are they going to work. Some suppliers promise to deliver in 2 weeks, while others have a standard delivery time of 2 months or more. Some suppliers feel the urge to give you unsolicited advice on your project. It's hard to balance how secretive you think you must be, and how open to external help is smart. 
...
While discussing with researchers, I understood that techniques claiming to be the holy grail were lagging behind in reproducibility and easy of use. Some others were claiming a resolution that was unrealistic. I knew that if we could tackle some of those challenges, we would have a compelling product. 
...
We built a list of key opinion leaders that would give us access to understanding different fields and their challenges. Moreover, we knew that getting these people onboard with a new technology was crucial to ease the introduction into new research topics. We identified conferences to attend, and started scheduling demo's both in person as online. 

The story on **how to go from funder to manager**, however, is a different one. I will by writing it in a few weeks. 
